...
SELECT 
  ...
  p.NetPay
FROM Payroll p
JOIN Salary sal ON p.SalaryID = sal.SalaryID
JOIN Staff st ON sal.StaffID = st.StaffID;
...
UPDATE Salary SET StaffID = 4 WHERE SalaryID = 4;
UPDATE Salary SET StaffID = 2 WHERE SalaryID = 3;
UPDATE Salary SET StaffID = 1 WHERE SalaryID = 2;
UPDATE Salary SET StaffID = 3 WHERE SalaryID = 5;
UPDATE Salary SET StaffID = 5 WHERE SalaryID = 7;
...
DROP TRIGGER trg_recalc_netpay ON Salary;
...
SELECT * FROM Payroll WHERE SalaryID = 5;
